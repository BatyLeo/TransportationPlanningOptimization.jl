...
@testset "Order with multiple commodities" begin
    @test begin
        ...
        order = Order(;
            commodities=light_commodities, time_step=2, max_transit_steps=14
        )
...
@testset "Order with custom commodity info" begin
    @test begin
        ...
        order = Order(;
            commodities=light_commodities, time_step=3, max_transit_steps=21
        )
...
@testset "Order aggregation of commodity sizes" begin
    @test begin
        ...
        order = Order(;
            commodities=light_commodities, time_step=1, max_transit_steps=7
        )
